...
#ifndef ZK_DTYPES__SRC_NUMPY_H_
#define ZK_DTYPES__SRC_NUMPY_H_
...
// We import_array in the zk_dtypes init function only.
#define PY_ARRAY_UNIQUE_SYMBOL _zk_dtypes_numpy_api
#ifndef ZK_DTYPES_IMPORT_NUMPY
