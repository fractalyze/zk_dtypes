...
#ifndef ZK_DTYPES_INCLUDE_ELLIPTIC_CURVE_SECP256R1_FQ_H_
#define ZK_DTYPES_INCLUDE_ELLIPTIC_CURVE_SECP256R1_FQ_H_

#include "zk_dtypes/include/field/big_prime_field.h"

namespace zk_dtypes::secp256r1 {

// secp256r1 (P-256) base field: p = 2²⁵⁶ - 2²²⁴ + 2¹⁹² + 2⁹⁶ - 1
struct FqBaseConfig {
...
struct FqMontConfig : public FqBaseConfig {
  ...
  constexpr static BigInt<4> kRSquared = {
      UINT64_C(3),
      UINT64_C(18446744056529682431),
      UINT64_C(18446744073709551614),
      UINT64_C(21474836477),
  };
  constexpr static uint64_t kNPrime = UINT64_C(1);
...
#endif  // ZK_DTYPES_INCLUDE_ELLIPTIC_CURVE_SECP256R1_FQ_H_
