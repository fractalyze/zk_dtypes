...
#ifndef ZK_DTYPES_INCLUDE_INTN_H_
#define ZK_DTYPES_INCLUDE_INTN_H_
...
struct intN {
 private:
  ...
  static_assert(
      ...
      "The underlying type must be a signed or unsigned 8-bit integer.");
...
template <>
struct numeric_limits<zk_dtypes::int1>
    : public zk_dtypes::internal::intN_numeric_limits_base<zk_dtypes::int1> {};
template <>
struct numeric_limits<zk_dtypes::uint1>
    : public zk_dtypes::internal::intN_numeric_limits_base<zk_dtypes::uint1> {};
template <>
struct numeric_limits<zk_dtypes::int2>
    : public zk_dtypes::internal::intN_numeric_limits_base<zk_dtypes::int2> {};
template <>
struct numeric_limits<zk_dtypes::uint2>
    : public zk_dtypes::internal::intN_numeric_limits_base<zk_dtypes::uint2> {};
template <>
struct numeric_limits<zk_dtypes::int4>
    : public zk_dtypes::internal::intN_numeric_limits_base<zk_dtypes::int4> {};
template <>
struct numeric_limits<zk_dtypes::uint4>
    : public zk_dtypes::internal::intN_numeric_limits_base<zk_dtypes::uint4> {};

}  // namespace std

#endif  // ZK_DTYPES_INCLUDE_INTN_H_
