...
//   - REGISTER_EXTENSION_FIELD_IMPL_MONT: Creates Name and NameMont (Montgomery)
...
// Core implementation macro for Montgomery form (creates Name and NameMont).
...
// Simple extension with Montgomery form (creates Name and NameMont)
...
// General polynomial with Montgomery form (creates Name and NameMont)
