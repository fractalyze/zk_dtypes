...
1. **Build the Extension Module**
   ...
   Run the appropriate Bazel command for your operating system to compile the C++ extension module:
...
2. **Install the Package**
   ...
   After the extension module is successfully built, install the package using pip from the repository root:
